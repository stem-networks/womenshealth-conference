...
const VolunteerCommunity: React.FC<VolunteerCommunityProps> = ({ generalVolunteerInfo, onelinerVolunteerInfo }) => {
    ...
    const [communityFormErrors, setCommunityFormErrors] = useState<CommunityFormErrors>({});
                        ...
                        <div className="col-md-9 mar_wrap1579">
                            <div className="call_cont_st1">
                                <div className="wr_sty1">
                                    ...
                                    <form id="joinourcommunityform" onSubmit={handleCommunitySubmit}>
                                        <div className="row">
                                            <div className="col-md-12 cont_wrap14666">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => setCommunityFormData({ ...communityFormData, email: e.target.value })}
                                                />
                                                {communityFormErrors ? communityFormErrors.email && <div id="joinourcommunityemail-error" style={{ color: "red" }}>{communityFormErrors ? communityFormErrors.email : ""}</div> : ""}
                                            </div>
                                            <div className="col-md-6 cont_wrap14666">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => setCommunityFormData({ ...communityFormData, fname: e.target.value })}
                                                />
                                                {communityFormErrors ? communityFormErrors.fname && <div id="jocfname-error" style={{ color: "red" }}>{communityFormErrors ? communityFormErrors.fname : ""}</div> : ""}
                                            </div>
                                            <div className="col-md-6 cont_wrap14666">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => setCommunityFormData({ ...communityFormData, lname: e.target.value })}
                                                />
                                                {communityFormErrors.lname && <div id="joclname-error" style={{ color: "red" }}>{communityFormErrors ? communityFormErrors.lname : ""}</div>}
                                            </div>
                    ...
                    <div className="modal-dialog modal-confirm fade-in" role="document" ref={modalRef}>
                        <div className="modal-content">
                            <div className="modal-header">
                                ...
                                <h4 className="modal-title w-100">Thank you for subscribing!</h4>
                                <p>You’ll be hearing from us soon with exciting updates and exclusive content.</p>
                            </div>
